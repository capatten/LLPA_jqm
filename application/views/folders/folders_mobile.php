...
<div class="folders-wrapper">
    ...
    ?>
        <div class="folder-container">
            <h2>
                <a href="#" data-fldr-id="<?php echo $userFolder['folder_id']; ?>" class="folder-link"><?php echo $userFolder['folder_name']; ?></a>
    ...
    <form id="get-selected-folder-frm" action="Get_Folder_Messages/" method="POST">
        <input id="selected-folder" name="selected-folder" type="hidden">
    </form>
</div>
